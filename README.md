...
![Screenshot](https://github.com/vladyslavpukhliak/LessMess/tree/main/Icons/lessmess.gif)

## Налаштування конфігураційного файлу
![How to edit config](https://github.com/vladyslavpukhliak/LessMess/tree/main/Icons/edit_config.gif)
...
```json
{
    ...
    "extension":{
        "шлях директорії куди слід перенести з досліджуваної директорії документи таких розширень":["розширення1", "розширення2", "розширення3"],
