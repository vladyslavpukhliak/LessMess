...
```json
{
    ...
    "extension":{
        "шлях, куди слід перенести з досліджуваної папки документи таких розширень":["розширення1",
...
**Зверніть увагу на деякі особливості роботи програми:**
- Шлях `"~/"` відповідає `"C:/Users/ім'я користувача/"` у ОС Windows або `"/home/ім'я користувача/"` у UNIX-подібних ОС (Mac, Linux).  
...
<br><br>
**Примітки щодо синтаксису `parameters.json`:**
